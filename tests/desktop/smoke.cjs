...
app.whenReady().then(async () => {
  ...
  assert.equal(logs.some((line) => line.includes("Log rotation skipped")), false, "Bootstrap logging must not reference log-rotation constants before initialization");
