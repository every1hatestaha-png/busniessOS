...
export function StatementTable({ statement, balanceLabel }: { statement: Statement; balanceLabel: string }) {
  ...
  return (
    <>
      <div className="mb-4 grid max-w-3xl grid-cols-1 gap-3 text-xs sm:grid-cols-2 lg:grid-cols-4"><div className="rounded border p-3"><p className="text-neutral-500">Opening balance</p><p className="mt-1 font-bold"><Money value={statement.openingBalance} /></p></div><div className="rounded border p-3"><p className="text-neutral-500">Period debit</p><p className="mt-1 font-bold"><Money value={debit} /></p></div><div className="rounded border p-3"><p className="text-neutral-500">Period credit</p><p className="mt-1 font-bold"><Money value={credit} /></p></div><div className="rounded border border-neutral-900 bg-neutral-950 p-3 text-white"><p className="text-neutral-300">{balanceLabel}</p><p className="mt-1 font-bold"><Money value={statement.closingBalance} /></p></div></div>
