...
const tones: Record<string, string> = {
  ACTIVE: "border-green-200 bg-green-50 text-green-700", COMPLETED: "border-green-200 bg-green-50 text-green-700", RECEIVED: "border-green-200 bg-green-50 text-green-700", PAID: "border-green-200 bg-green-50 text-green-700", "In Stock": "border-green-200 bg-green-50 text-green-700", Clear: "border-green-200 bg-green-50 text-green-700",
