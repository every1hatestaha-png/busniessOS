...
const baseCustomerSchema = z.object({
  ...
  taxId: z.string().trim().max(40, "NTN/CNIC is too long").optional(),
  province: z.string().trim().max(80, "Province is too long").optional(),
  registrationType: z.enum(["Registered", "Unregistered"]).or(z.literal("")).optional(),
