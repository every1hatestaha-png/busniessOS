...
const prefixes: Record<DocumentKind, string> = { SALES_ORDER: "SO", PURCHASE_ORDER: "PO", INVOICE: "INV", PAYMENT_RECEIPT: "PAY", CREDIT_NOTE: "CN", DEBIT_NOTE: "DN", CUSTOMER_RETURN: "CR", SUPPLIER_RETURN: "SR" };
