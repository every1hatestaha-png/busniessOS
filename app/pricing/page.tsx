  ...
  return (
    <main className="min-h-screen bg-[#fbfcfa] text-slate-950">
      ...
      <section className="mx-auto max-w-6xl px-5 py-14 sm:px-6">
        ...
        <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-950"><strong>Billing note:</strong> final paid pricing, renewal terms and payment method are shown before paid activation. Your business data remains separate from subscription state.</div>
      </section>
    </main>
  );
}
