      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 rounded-3xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
          ...
          <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700">
            ...
            <section><h2 className="text-lg font-semibold text-slate-950">Subscriptions and billing</h2><p className="mt-2">Pricing, billing frequency, renewal terms, included modules, trial terms and the available cancellation method will be shown before a paid subscription is activated. An upgrade or renewal request by itself does not create a charge. Charges should only begin after the applicable paid checkout or activation flow is completed, and ending or cancelling paid access does not automatically delete the workspace’s operational records.</p></section>
