...
import { DEMO_CUSTOMERS, findCustomer } from "@/lib/demo-data";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <MetricCard label="Total sales" value={formatPKR(customer.totalSales)} detail="Lifetime demo sales" icon={ShoppingCart} />
        <MetricCard label="Total payments" value={formatPKR(customer.totalPayments)} detail="Lifetime demo receipts" icon={CircleDollarSign} />
      </div>
