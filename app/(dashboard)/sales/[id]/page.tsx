    ...
    <div className="mx-auto max-w-[1500px] space-y-6">
      ...
      <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
        <div className="space-y-6">
          ...
          {sale.status !== "CANCELLED" && canManageFinancials && <Card className="shadow-none"><CardContent className="pt-5"><CustomerReturnForm salesOrderId={sale.id} items={sale.items.map((item) => ({ id: item.id, productName: item.productName, quantity: item.quantity.toNumber() }))} /></CardContent></Card>}
        </div>
